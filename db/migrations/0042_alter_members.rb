Sequel.migration do
  up do
    alter_table(:members) do
      add_column :halt_mbrship_renewal, TrueClass, default: false
    ...
    from(:members).update(halt_mbrship_renewal: false)
    ...
    alter_table(:members) do
      ...
      set_column_not_null :halt_mbrship_renewal
  ...
  down do
    alter_table(:members) do
      drop_column :halt_mbrship_renewal
